...
class DBService:
    def __init__(self):
        ...
        self.chat_history.create_index([("user_id", ASCENDING), ("video_id", ASCENDING), ("session_id", ASCENDING)], unique=True)
    ...
    def create_session(self, user_id: str, video_id: str, session_id: str):
    ...
    def add_message(self, user_id: str, video_id: str, session_id: str, role: str, message: str):
    ...
    def get_chat_history(self, user_id: str, video_id: str, session_id: str):
        """Get full chat history for a session"""
        doc = self.chat_history.find_one({"user_id": user_id, "video_id": video_id, "session_id": session_id})
        if not doc:
            return None
    ...
    def list_sessions(self, user_id: str):
        ...
        docs = self.chat_history.find({"user_id": user_id}).sort("last_updated", DESCENDING)
        return [
            {
